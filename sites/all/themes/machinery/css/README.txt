...
To use these stylesheets, rename the files and machinery with the name of your theme.
...
machinery-alpha-default-narrow.css  
...
machinery-alpha-default-normal.css
...
machinery-alpha-default-wide.css
